...
return [
    ...
    'exist' => 'Thuộc tính: không tồn tại',
    'format_password' => 'Vui lòng nhập ít nhất 10 ký tự, chữ cái đặc biệt, chữ hoa và chữ thường, số.',
    'password' => 'mật khẩu',
    'email_incorrect' => 'Email không chính xác',
    'current_password_not_confirmed' => 'Mật khẩu hiện tại không khớp',
    'max_5_files' => 'Bạn chỉ có thể tải lên tối đa 5 ảnh',
    'max_1_video' => 'Bạn chỉ có thể tải lên tối đa 1 video'
];