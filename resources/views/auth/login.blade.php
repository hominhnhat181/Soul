...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('front/login/css/owl.carousel.min.css')}}">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('front/login/css/bootstrap.min.css')}}">
  ...
  <div class="content" style="background-image: url(front/login/images/wallpaper.jpg)">
    <div class="container">
      <div class="row">
